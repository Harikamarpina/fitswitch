  ...
  return (
    <div className="min-h-screen bg-black text-white px-5 py-8">
      <div className="max-w-2xl mx-auto">
        <Link to={`/owner/gyms/${gymId}/plans`} className="underline text-zinc-200 hover:text-white">
          ← Back
        </Link>

        <h1 className="text-2xl font-bold mt-4">Add Gym Plan</h1>
        <p className="text-zinc-300 mt-2">Create a new subscription plan for your gym.</p>
