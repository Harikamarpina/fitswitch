    ...
    <div className="min-h-screen bg-black text-white px-4 py-12">
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-bold tracking-tight">Edit <span className="text-lime-400">Gym Plan</span></h1>
          <p className="text-zinc-500 mt-2">Adjust pricing and duration for your membership plan.</p>
        </div>
        ...
        {fetchLoading ? (
          <div className="flex flex-col items-center justify-center py-20 bg-zinc-900/30 border border-zinc-800/50 rounded-[2.5rem]">
            <div className="w-10 h-10 border-4 border-lime-400/30 border-t-lime-400 rounded-full animate-spin"></div>
            <p className="mt-4 text-zinc-500 font-medium tracking-wide uppercase text-xs">Loading plan...</p>
          </div>
        ) : (
          <form
