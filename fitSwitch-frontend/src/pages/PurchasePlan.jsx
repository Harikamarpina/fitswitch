  ...
  return (
    <div className="min-h-screen bg-black text-white px-5 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-bold mt-4">Join Gym Plan</h1>
        <p className="text-zinc-300 mt-2">Review your selected plan and join the gym.</p>
        ...
        <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-8">
          <h2 className="text-xl font-bold mb-6">Plan Details</h2>
