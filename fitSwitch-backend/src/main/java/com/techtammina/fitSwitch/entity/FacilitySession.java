...
public class FacilitySession {
    ...
    public Long getFacilityPlanId() { return facilityPlanId; }
    public void setFacilityPlanId(Long facilityPlanId) { this.facilityPlanId = facilityPlanId; }
